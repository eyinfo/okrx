...
import io.github.eyinfo.okrx.OkRxKeys;
...
public class BaseRequest {
    ...
    protected boolean cacheDealWith(CallStatus callStatus,
        ...
        if (callStatus != CallStatus.OnlyNet) {
            String cacheData = NetCacheManager.getInstance().getRequestCacheData(String.valueOf(ckey.hashCode()));
            if (successAction != null && ObjectJudge.isEmptyString(cacheData)) {
                ...
                if (callStatus == CallStatus.TakNetwork) {
                    ...
                    return callStatus != CallStatus.OnlyCache;
                }
            }
        }
        return true;
